export default function HowItWorks() {
    const steps = [
        {
            number: "01",
            title: "Cuéntame tu objetivo y tu punto de partida",
            description:
        ...
        },
        {
            ...
            description:
                "Hablamos contigo, resolvemos dudas y definimos un enfoque realista para que sepas cómo empezar.",
        },
        {
            number: "03",
            title: "Empiezas con una estrategia adaptada a ti",
            description:
                "Recibes entrenamiento, nutrición y seguimiento para avanzar con una estructura clara y sostenible.",
        },
    ];
            ...
            <div className="max-w-6xl mx-auto">
                <div className="max-w-2xl mx-auto text-center mb-10 md:mb-12">
                    ...
                    <p className="text-[#B0B0B0] text-base md:text-lg leading-relaxed mt-4">
                        La idea es que sepas desde el principio qué va a pasar y qué pasos
                        vamos a seguir antes de empezar a trabajar.
                    </p>
                </div>
